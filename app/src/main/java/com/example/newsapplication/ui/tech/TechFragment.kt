...
class TechFragment : Fragment(), NewsAdapter.ClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //recycler
        val recyclerView: RecyclerView = view.findViewById(R.id.tech_recyclerview)
        val layoutManager: RecyclerView.LayoutManager = LinearLayoutManager(context)
        recyclerView.layoutManager = layoutManager

        //Get health news request and pass to adapter////////////////////////////////////////////
        val call: Call<ResponseModel> = request.getTechnologyNews()
